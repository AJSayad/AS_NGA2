...
ngacase.CellArrays = ['LP', 'Lrho', 'LrhoE', 'VOF']

UpdatePipeline(time=0.0, proxy=ngacase)

# save data
SaveData('/mnt/RRG2_Backup/Andrew_backup/aerobreakup/AIAAWG_shot3/2D/100cpd_PLICNET_longrun_6-5-2025/temp1/liquid_data.csv', proxy=ngacase, WriteTimeSteps=1,
    WriteTimeStepsSeparately=1,
    ChooseArraysToWrite=1,
    CellDataArrays=['LP', 'Lrho', 'LrhoE', 'VOF'],
    Precision=10,
