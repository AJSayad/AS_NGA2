      ...
      create_and_initialize_flow_solver: block
         ...
         if (.not.restarted)then !AS not restartarting
            ...
            do i=cfg%imino_,cfg%imaxo_
               ...
               do j = cfg%jmino_,cfg%jmaxo_
                  !print*, "j = ", j
                  if ((cfg%xm(i).gt.0.024375 - 1e-5).and.(cfg%xm(i).lt.0.024375 + 1e-5))then
            ...
            do j = 101,103
               print*, "j = ", j
               print*, "VOF(33,j,1): ", vf%VF(33,j,1)
               print*, "U(33,j,1) face value: ", fs%U(33,j,1)
               print*, "Ui(33,j,1) cell value: ", fs%Ui(33,j,1)
               print*, "V(33,j,1) face value: ", fs%V(33,j,1)
               print*, "Vi(33,j,1) cell value: ", fs%Vi(33,j,1)
            end do
