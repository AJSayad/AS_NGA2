         ...
         do k=cfg%kmino_,cfg%kmaxo_
            do j=cfg%jmino_,cfg%jmaxo_
               do i=cfg%imino_,cfg%imaxo_
                  ...
                  if ((fs%VF(i,j,k).lt.1.0_WP).and.(cfg%xm(i).lt.Xs)) then       ! if we're in a gas or multiphse cell and in post shock region
                     !print*, "Setting post shock"
                  ...
                  elseif ((fs%VF(i,j,k).lt.1.0_WP).and.(cfg%xm(i).gt.Xs)) then   ! if we're in a gas cell or multiphase cell and in pre shock region
                     !print*, "Setting pre shock"
